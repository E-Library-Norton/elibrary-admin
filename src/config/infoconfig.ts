...
export const billingInfoContent: InfobarContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      description:
        "Clerk Billing costs 0.7% per transaction, plus transaction fees paid directly to Stripe. Clerk Billing is not the same as Stripe Billing - plans and pricing are managed through the Clerk Dashboard and won't sync with existing Stripe books. Clerk uses Stripe only for payment processing.",
      links: []
    },
    {
      title: 'Setup Requirements',
      description:
        "To enable billing, navigate to Billing Settings in the Clerk Dashboard and enable billing for your application. Choose between Clerk's development gateway (for testing) or your own Stripe account (for bookion). Note: A Stripe account created for development cannot be used for bookion.",
      links: [
        {
...
export const bookInfoContent: InfobarContent = {
  title: 'Books Management',
  sections: [
    {
      title: 'Overview',
      description:
        'The books page allows you to manage your book catalog. You can view all books in a table format with server-side functionality including sorting, filtering, pagination, and search capabilities. Use the "Add New" button to create new books.',
      links: [
        {
          title: 'Book Management Guide',
          url: '#'
        }
      ]
    },
    {
      title: 'Adding books',
      description:
        'To add a new book, click the "Add New" button in the page header. You will be taken to a form where you can enter book details including name, description, price, category, and upload book images.',
      links: [
        {
          title: 'Adding books Documentation',
          url: '#'
        }
      ]
    },
    {
      title: 'Editing books',
      description:
        'You can edit existing books by clicking on a book row in the table. This will open the book edit form where you can modify any book information. Changes are saved automatically when you submit the form.',
      links: [
        {
          title: 'Editing books Guide',
          url: '#'
        }
      ]
    },
    {
      ...
      description:
        'books can be deleted from the book listing table. Click the delete action for the book you want to remove. You will be asked to confirm the deletion before the book is permanently removed from your catalog.',
      links: [
        {
          title: 'book Deletion Policy',
          url: '#'
        }
      ]
    },
    {
      ...
      description:
        'The book table includes several powerful features to help you manage large book catalogs efficiently. You can sort columns by clicking on column headers, filter books using the filter controls, navigate through pages using pagination, and quickly find books using the search functionality.',
      links: [
        {
    ...
    },
    {
      title: 'book Fields',
      description:
        'Each book can have the following fields: Name (required), Description (optional text), Price (numeric value), Category (for organizing books), and Image Upload (for book photos). All fields can be edited when creating or updating a book.',
      links: [
        {
          title: 'book Fields Specification',
          url: '#'
        }
      ]
    }
